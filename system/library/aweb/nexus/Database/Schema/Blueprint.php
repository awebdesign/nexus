...
namespace Aweb\Nexus\Database\Schema;

use Closure;
use BadMethodCallException;
use Aweb\Nexus\Support\Fluent;
use Aweb\Nexus\Database\Connection;
use Aweb\Nexus\Support\Traits\Macroable;
use Aweb\Nexus\Database\SQLiteConnection;
use Aweb\Nexus\Database\Schema\Grammars\Grammar;
...
class Blueprint
{
     ...
     *
     * @var \Aweb\Nexus\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @return \Aweb\Nexus\Support\Fluent
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \Aweb\Nexus\Support\Fluent|\Aweb\Nexus\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Aweb\Nexus\Database\Schema\ColumnDefinition
     */
